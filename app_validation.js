...
function checkInputs() {
    ...
    if (name_surnameValue === "") {
        ...
        setErrorFor(name_surname, "Name field can't be empty!")
    } else if (!isNameSurname(name_surnameValue)) {
        // prikazuje da nije validno, dodaje klasu greške
        setErrorFor(name_surname, "Invalid name and surname!");
    } else {
    ...
    if (emailValue === "") {
        // prikazuje grešku, dodaje klasu greške
        setErrorFor(email, "E-mail field can't be empty!");
    ...
    if (messageValue === "") {
        ...
        // prikazuje da nije validno, dodaje klasu greške
        setErrorFor(message, "Invalid message!");
    } else {
        // dodaje klasu da je dobro
